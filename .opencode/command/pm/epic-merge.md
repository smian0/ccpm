---
description: epic merge command
agent: build
---
# Epic Merge
...
Closes epic #$(grep 'github:' .opencode/epics/$ARGUMENTS/epic.md | grep -oE '#[0-9]+')"
```
...
epic_issue=$(grep 'github:' .opencode/epics/archived/$ARGUMENTS/epic.md | grep -oE '[0-9]+$')
